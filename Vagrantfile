...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "MLWB" do |foohost|
  end
  ...
  config.vm.provision "shell", path: "core.sh"
  config.vm.provision "shell", path: "booster.sh"
  config.vm.provision "shell", path: "acessories.sh"
